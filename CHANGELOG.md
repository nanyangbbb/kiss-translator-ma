...
Initial public release of KISS Translator MA.

- MathAcademy specialization fork of KISS-Translator (GPL-3.0)
- LaTeX-safe formula protection with placeholder + DOM clone restore
- Knowledge-graph SVG translation
- Read-aloud with spoken-formula conversion (DeepSeek) and local speechSynthesis
- User-supplied DeepSeek API key, direct connection (no backend)
