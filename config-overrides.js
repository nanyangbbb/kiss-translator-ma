...
// @match         https://nanyangbbb.github.io/kiss-translator-ma/*
// @icon          ${process.env.REACT_APP_LOGOURL}
// @downloadURL   https://raw.githubusercontent.com/nanyangbbb/kiss-translator-ma/main/dist/kiss-translator.user.js
// @updateURL     https://raw.githubusercontent.com/nanyangbbb/kiss-translator-ma/main/dist/kiss-translator.user.js
  ...
  if (config.optimization.minimize) {
    config.optimization.minimizer = [
      new TerserPlugin({
        ...
        terserOptions: {
          // 旧版 Android WebView（X Browser）不支持 ?? / ??= / ||= 等语法，
          // 强制 terser 输出 ES5，避免整段脚本解析失败、一行不执行。
          ecma: 5,
          compress: { ecma: 5 },
          format: {
            ecma: 5,
