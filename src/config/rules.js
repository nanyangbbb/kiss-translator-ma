...
export const DEFAULT_KEEP_SELECTOR = `code, cite, math, .math, a:has(code), .katex, .katex-display, .MathJax, .MathJax_Display, .MathJax_Preview, .MathJax_CHTML, .MathJax_SVG, .mjpage, mjx-container, mjx-math, [class*='mathjax'], .math-inline, .math-display`;
...
export const GLOBLA_RULE = {
  ...
  terms: "", // 专业术语
  aiTerms: "", // AI专业术语
  apiSlug: OPT_TRANS_DEEPSEEK, // 翻译服务
  fromLang: "auto", // 源语言
  toLang: "zh-CN", // 目标语言
